function trialData  = runSingleTrial_2tar_ET(trial, design, visual, settings, scr)
    ...
    %trial_timer = 0;
    while flip_count <= visual.trialFlips
        ...
        if flip_count >= gapDurFlip && flash_on_screen < visual.flashFlips
            % Draw the flash
